  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <h1 class="page-header">Edit Transformer</h1>


        <form class = "form" action="registertransformer.php">
          <?php 
          echo "<h4>WSDL URL * </h4>" ; 
         echo "<input type='url' id='wsdlurl' size='122'></br></br>";
          ...
          echo "<h4>Supported Abstraction</h4>" ; 
          populateDropDownList("id, name", "filter", $mysqli, 760); echo "</br></br>"; 
          ...
          <table> 
          <tr >
          <td width="405px"><h4>Input Data Type (Optional)</h4> </td> 
          <td><h4>Output Data Type (Optional)</h4> </td> 
          <tr>
